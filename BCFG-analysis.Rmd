...
kable(flipped_characteristics, format = "html", caption = "Participant characteristics by condition") %>%
    ...
    footnote(general = "This table summarizes patient characteristics for participants overall, within the control group, and within each experimental condition.") 
